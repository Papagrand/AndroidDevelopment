        ...
        btnFetch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new Thread(new Runnable() {
                    public void run() {
                        try{
                            String content = getContent("https://github.com/Papagrand?tab=repositories/");
                            webView.post(new Runnable() {
                                public void run() {

                                    webView.loadDataWithBaseURL("https://github.com/Papagrand?tab=repositories/",content,
                                            "text/html", "UTF-8", "https://github.com/Papagrand?tab=repositories/");
