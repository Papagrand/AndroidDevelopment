...
public class UserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        yearBox = findViewById(R.id.user_year);
        delButton = findViewById(R.id.user_deleteButton);
        saveButton = findViewById(R.id.user_saveButton);
    ...
    public void save(View view){
        ...
        cv.put(DatabaseHelper2.COLUMN_YEAR, Integer.parseInt(yearBox.getText().toString()));
